                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="name" class="form-controll" placeholder="Enter caregory Name" wire:model="name" wire:keyup="generateSlug"/>
                                    @error('name')
                                ...
                                <div class="mt-3 nt-3">
                                    ...
                                    <input type="file" class="form-controll" wire:model="newimage" />
                                    @error('newimage')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
